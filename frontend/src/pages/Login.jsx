...
//   password: z.string().min(8, "password is to week"),
// });
          ...
          <div className="bg-[#020617]/90 backdrop-blur-2xl rounded-2xl p-8 border border-white/10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2 rounded-lg bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white font-semibold hover:scale-[1.03] hover:shadow-[0_0_20px_rgba(0,255,255,0.4)] transition-all duration-300 flex justify-center items-center gap-2"
              >
                {loading ? (
                  <>
